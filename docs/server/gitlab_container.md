---
title: GitLab (Docker Container)
description: Docker コンテナを使用した GitLab をインストール・運用
#sidebar_position: 0
#id: home
#slug: /my-custom-url
---
...
:::note
これを省略すると、gitlab-runner を使おうとしたときに自己 CA 証明書が信頼されないので、自動テストが必ずエラーになります。
:::
...
2. 初回ログイン
    ...
    ![](./gitlab_container/00_gitlab_login.png)
